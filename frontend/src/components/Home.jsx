    ...
    <div className="flex min-h-screen items-center px-[10%] pt-24">
      <div className="flex w-full flex-col-reverse items-center justify-between gap-16 lg:flex-row">
        ...
        >
          ...
          >
            Computer Science graduate passionate about building modern web applications, mobile apps and backend systems using React, ASP.NET Core MVC, Django and Flutter, HTML, CSS, JavaScript, Bootstrap, Tailwind CSS, Python, PHP, WordPress, RESTful APIs, Git, SQL Server, MySQL, PostgreSQL, Docker, and Flutter.
          </motion.p>
